# cluster-storage-operator - AI Navigation

**Repository:** https://github.com/openshift-splat-team/cluster-storage-operator
...
This is **Tier 2** project-specific documentation for cluster-storage-operator.

- **New to this project?** → Start with [Development Guide](ai-docs/cluster-storage-operator_DEVELOPMENT.md)
- **Writing tests?** → See [Testing Guide](ai-docs/cluster-storage-operator_TESTING.md)
...
When working on cluster-storage-operator:
- ✅ **DO**: Read project-specific docs from `./ai-docs/` first
- ✅ **DO**: Check development workflow in `./ai-docs/cluster-storage-operator_DEVELOPMENT.md`
...
|------|-----------|-----------|
| **Local development** | [Development Guide](ai-docs/cluster-storage-operator_DEVELOPMENT.md) | [Testing Guide](ai-docs/cluster-storage-operator_TESTING.md) |
| **Running tests** | [Testing Guide](ai-docs/cluster-storage-operator_TESTING.md) | [Components](ai-docs/architecture/components.md) |
...
```
ai-docs/
├── cluster-storage-operator_DEVELOPMENT.md  # Build, test, develop
├── cluster-storage-operator_TESTING.md      # Test suites and strategies
...
- cluster-storage-operator components and architecture
...
**Navigation**: Start with [Development Guide](ai-docs/cluster-storage-operator_DEVELOPMENT.md) for project setup and workflow.

**GitHub**: https://github.com/openshift-splat-team/cluster-storage-operator
