# cluster-storage-operator Domain Models
...
This directory documents the domain models, custom resource definitions (CRDs), and core data structures used in cluster-storage-operator.
...
- [Development Guide](../cluster-storage-operator_DEVELOPMENT.md) - Adding new fields
