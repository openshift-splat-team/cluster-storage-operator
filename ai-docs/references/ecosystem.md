# cluster-storage-operator Ecosystem and References
...
This document provides links to related projects, upstream dependencies, documentation, and external resources relevant to cluster-storage-operator.
...
**Relationship:** cluster-storage-operator runs on Kubernetes
...
**Relationship:** cluster-storage-operator is part of OpenShift platform
...
Key libraries and frameworks used by cluster-storage-operator:
...
- [Development Guide](../cluster-storage-operator_DEVELOPMENT.md) - Build and develop
- [Testing Guide](../cluster-storage-operator_TESTING.md) - Test suites
