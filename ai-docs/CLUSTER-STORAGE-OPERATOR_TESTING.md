# cluster-storage-operator Testing Guide
...
This guide covers all test suites for cluster-storage-operator and how to run them.
...
- `pull-ci-cluster-storage-operator-unit` - Unit tests
- `pull-ci-cluster-storage-operator-integration` - Integration tests (if enabled)
- `pull-ci-cluster-storage-operator-e2e-*` - E2E test suites

**Post-submit tests (run on merge):**
- `branch-ci-cluster-storage-operator-unit` - Unit tests
- `branch-ci-cluster-storage-operator-e2e-*` - Full E2E suite
...
- [Development Guide](cluster-storage-operator_DEVELOPMENT.md) - Build and development workflow
