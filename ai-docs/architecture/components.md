# cluster-storage-operator Components
...
This document describes the major components and architecture of cluster-storage-operator.
...
- **defaultstorageclass** - `pkg/operator/defaultstorageclass`
- **volumedatasourcevalidator** - `pkg/operator/volumedatasourcevalidator`
...
- [Development Guide](../cluster-storage-operator_DEVELOPMENT.md) - How to build and run
- [Testing Guide](../cluster-storage-operator_TESTING.md) - How to test components
